...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2021 at 04:45 PM
...
(134, 'CODE - C', 'Intermediate', 'C and C++ Programming based Questions.\r\nTypes\r\n-> Output based\r\n-> Error search\r\n-> Theory\r\n- >Architecture\r\n-> OOPS', 5, 1, 1611859500, 1611861300, '23031999', 0, 0, 0, -1, 1, 0.5, 60, 24, '2020-12-15 14:54:23'),
...
(156, 'Logical Reasoning 1.0', 'Intermediate', 'Logical Reasoning Questions To Prepare For SBI PO Exams', 30, 1, 0, 0, 'LR2021', 1, 1, 0, -1, 1, 0, 60, 41, '2021-04-16 19:25:22'),
(167, 'C++ Programming Predict Output', 'Intermediate', 'Predict Output', 5, 1, 0, 0, 'CP2021', 0, 0, 1, -1, 2, 1, 60, 24, '2021-04-17 15:08:53');
...
--
ALTER TABLE `attempts`
  MODIFY `attempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `question_bank`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=541;
