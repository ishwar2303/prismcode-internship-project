...
DROP TABLE IF EXISTS `reported_questions`;
...
LOCK TABLES `reported_questions` WRITE;
/*!40000 ALTER TABLE `reported_questions` DISABLE KEYS */;
/*!40000 ALTER TABLE `reported_questions` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-10-15 17:30:12
