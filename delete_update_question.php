										...
										<div style="margin:3px 0px;" class="row p-4 mb-2 border rounded border-muted set-container">
											...
											<div class="col-sm-12 col-lg-6">
												<div class="form-group">
													...
													<textarea type="text" name="option1[]" class="form-control option1" placeholder="Option A" required="true" disabled="true"><?php echo $option1;?></textarea>
												</div>
											</div>
											<div class="col-sm-12 col-lg-6">
												<div class="form-group">
													<label class="form-label">Option B</label>
													<textarea type="text" name="option2[]" class="form-control option2" placeholder="Option B" required="true" disabled="true"><?php echo $option2;?></textarea>
												</div>
											</div>
											<div class="col-sm-12 col-lg-6">
												<div class="form-group">
													<label class="form-label">Option C</label>
													<textarea type="text" name="option3[]" class="form-control option3" placeholder="Option C" required="true" disabled="true"><?php echo $option3;?></textarea>
												</div>
											</div>
											<div class="col-sm-12 col-lg-6">
												<div class="form-group">
													<label class="form-label">Option D</label>
													<textarea type="text" name="option4[]" class="form-control option4" placeholder="Option D" required="true" disabled="true"><?php echo $option4;?></textarea>
												</div>
											</div>
											<div class="col-sm-12 col-lg-12">
												<div class="form-group">
