...
<body class="grey lighten-4">
	<nav  style="box-shadow:0px 0px 18px 0px rgba(0,0,0,0.6);position:fixed;background:#3b72c0;" class="header" style="display:flex;">
		<div class="" style="height:100%;display:flex;justify-content: space-between;align-items: center;">
          <a style="line-height: 0" id="home-link" href="index.php" class="ml-30px"><span><h4 class="mg-0">QuizWit</h4></span></a>
