         ...
         <form id ="update_quiz_form" action ="update_quiz_details.php" method="POST" onsubmit="return validation()">
           ...
           <div class="col-sm-12 col-lg-12">
            <label class="form-label">Time duration</label>
                ...
                <label class="selectgroup-item">
                   <input type="radio" name="time" value="3600" class="selectgroup-input" <?php echo $t3." ";?> required="">
                   <span class="selectgroup-button timing">1 hr</span>
                </label>
                <label class="selectgroup-item">
                   <input type="radio" name="time" value="7200" class="selectgroup-input" <?php echo $t4." ";?> required="">
                   <span class="selectgroup-button timing">2 hrs</span>
                </label>
                <label class="selectgroup-item">
                   <input type="radio" name="time" value="10800" class="selectgroup-input" <?php echo $t5." ";?> required="">
